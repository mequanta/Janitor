...
namespace IdentityServer3.Core.Configuration
{
    ...
    {
        readonly Microsoft.IdentityModel.Web.CookieTransform _encrypt;
        readonly Microsoft.IdentityModel.Web.CookieTransform _sign;
        ...
        {
            _encrypt = new Microsoft.IdentityModel.Web.RsaEncryptionCookieTransform(certificate);
            _sign = new Microsoft.IdentityModel.Web.RsaSignatureCookieTransform(certificate);
        }
